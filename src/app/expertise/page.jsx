...
const expertiseItems = [
  ...
  },
  {
    ...
    excerpt:
      "Over 25 years of criminal practice, ACA Juris has also dealt with offences under various statutes, including the Wild Life Protection Act, Juvenile Justice Act, POCSO Act, Drugs and Cosmetics Act, and labour and employment statutes.",
  },
];
        ...
        <div className={styles.sectionInner}>
          <div className={styles.practiceGrid}>
            {expertiseItems.map(({ slug, title, icon, excerpt }) => (
              <Link key={slug} href={`/expertise/${slug}`} className={styles.card}>
