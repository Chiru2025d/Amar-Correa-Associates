        ...
        <div className="legal-grid">
          ...
          <div className="legal-card">
            ...
            <div className="legal-content">
              ...
              <h4 className="update-title">An <strong>Incorrect</strong> View On Trial Court's Powers U/S 173(8) Cr.P.C</h4>
            </div>
          </div>
          ...
          <div className="legal-card">
            ...
            <div className="legal-content">
              ...
              <h4 className="update-title">The <strong>Correct</strong> View On Trial Court's Powers U/S 173(8) Cr.P.C</h4>
            </div>
          </div>
        </div>
      </div>
